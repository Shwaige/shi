...
# import pymysql
#
# mysql_host = 'uat-qingflow.rwlb.rds.aliyuncs.com'
# mysql_port = 3306
# mysql_user = 'root_user'
# mysql_password = '11ec-9791-309c236089f2'
# mysql_database = 'qflow'
#
# greenplum_host = 'gp-bp1n42w58fx9v617vo-master.gpdb.rds.aliyuncs.com'
# greenplum_port = 5432
# greenplum_user = 'qflowuser'
# greenplum_password = '11ec-b5ab-cb08c29c0438'
# greenplum_database = 'qflowuat'
#
# default_num = "100"
...
#         'select ws_id, dataset_id from bi_dataset_config where ws_id = 110146 order by ws_id')
#
#     # 打印受影响的行数
...
#     mysqlConn = mysqldb.cursor()
#     mysqlConn.execute(
#         "replace into bi_data_capacity_and_num (`ws_id`,`capacity`,`virtual_capacity`,`data_type`) (select ws_id ,sum(capacity) as capacity ,sum(virtual_capacity) as virtual_capacity ,'dataall' from bi_data_capacity_and_num where ws_id = 110146 and `data_type` != 'dataall' group by ws_id )")
#
#
